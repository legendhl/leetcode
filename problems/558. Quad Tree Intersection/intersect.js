 ...
 * @return {Node}
 * Runtime: 208 ms, faster than 16.67%
...
var intersect = function (quadTree1, quadTree2) {
    ...
    if ((quadTree1.isLeaf && quadTree1.val) || (quadTree2.isLeaf && quadTree2.val)) {
        ...
        let subNodes = ['topLeft', 'topRight', 'bottomLeft', 'bottomRight']
            .map(pos => intersect(quadTree1[pos], quadTree2[pos]));
        node = new Node(false, false, subNodes[0], subNodes[1], subNodes[2], subNodes[3]);
    }
    if (!node.isLeaf
        && node.topLeft.isLeaf
        ...
        node = new Node(node.topLeft.val, true, null, null, null, null);
    }
    return node;
};